        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 md:gap-8">
          ...
          <div className="flex flex-col items-start lg:items-end gap-3 md:gap-4">
            ...
            <div className="flex gap-2 md:gap-3">
              {/* Facebook */}
              <a href="https://www.facebook.com/AI.USKY/" target="_blank" rel="noopener noreferrer" aria-label="Facebook USKY" className="w-10 h-10 flex items-center justify-center rounded-full bg-white hover:bg-gray-200 transition-colors">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/usky.ai/" target="_blank" rel="noopener noreferrer" aria-label="Instagram @usky.ai" className="w-10 h-10 flex items-center justify-center rounded-full bg-white hover:bg-gray-200 transition-colors">
              ...
              {/* TikTok */}
              <a href="https://www.tiktok.com/@usky.ai" target="_blank" rel="noopener noreferrer" aria-label="TikTok @usky.ai" className="w-10 h-10 flex items-center justify-center rounded-full hover:opacity-80 transition-opacity">
                <Image 
              ...
              {/* X (Twitter) */}
              <a href="https://x.com/Usky_ai" target="_blank" rel="noopener noreferrer" aria-label="X @Usky_ai" className="w-10 h-10 flex items-center justify-center rounded-full bg-white hover:bg-gray-200 transition-colors">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@usky_ai" target="_blank" rel="noopener noreferrer" aria-label="YouTube @usky_ai" className="w-10 h-10 flex items-center justify-center rounded-full bg-white hover:bg-gray-200 transition-colors">
