    ...
    <div className="min-h-screen bg-[#0a1628] text-foreground dark">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute top-1/2 translate-y-12 left-4 md:left-6 lg:left-12 right-4 md:right-6 lg:right-12">
          ...
          <p className="text-xs md:text-sm lg:text-base text-gray-300 mb-3 md:mb-4 max-w-2xl">
      ...
      <CarouselSection title="Late Films" items={mockFilms} />
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
          {mockSeries[0] && (
            <Link href={`/dashboard/series/detail?id=${mockSeries[0].id}`} className="group block">
              <div className="relative w-full aspect-[1014/588] rounded-3xl overflow-hidden bg-black">
                <Image
                  src={mockSeries[0].image || "/placeholder.svg"}
          ...
          <div className="flex flex-col gap-6">
            {mockSeries.slice(1, 4).map((series) => (
              <Link key={series.id} href={`/dashboard/series/detail?id=${series.id}`} className="relative rounded-2xl overflow-hidden group">
                <div className="relative w-full aspect-[322/180] bg-black">
                  <Image
